---Use yazi in neovim to select and open files for editing
---@param dir? string Directory to start yazi from
---@param fullscreen? boolean Open on fullscreen
local yazi = function(dir, fullscreen)
  local terminal = require('lib.terminal')

  -- Remember the window we came from so we can return to it (and edit
  -- the selected files there) when yazi exits. This is the window that
